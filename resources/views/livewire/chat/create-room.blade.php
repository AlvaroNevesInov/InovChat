<div>
    <button
        ...
        class="w-full p-3 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-lg shadow transition"
    >
        + Nova Sala
    </button>
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <input
                                            ...
                                            placeholder="Ex: Equipa de Marketing"
                                        >
                                        @error('nome')
                                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
